...
SERVER_NAME='biz-java-server'
JAR_NAME='biz-java-server-1.0.jar'
cd `dirname $0`
DEPLOY_DIR=`pwd`
...
CONFIG_FILES="-Dlogging.config=logback-spring.xml -Dspring.config.location=application.properties "
